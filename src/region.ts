 ...
 *
 * @module @zzusp/dsh-compaction-convergent/region
 */
...
/**
 * The framed checkpoint would not shrink the selected source range. This is
 * the only transaction failure that pressure compaction may answer by
 * selecting a larger balanced range.
 */
